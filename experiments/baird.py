...
alpha = 0.004
mu = 4
gtd = td.GTD2AC(alpha=alpha, beta=mu * alpha, phi=phi)
gtd.name = r"GTD2-AC $\alpha$={} $\mu$={}".format(alpha, mu)
gtd.color = "k"
methods.append(gtd)

alpha = 0.004
mu = 4
tdc = td.TDCAC(alpha=alpha, beta=mu * alpha, phi=phi)
tdc .name = r"TDC-AC $\alpha$={} $\mu$={}".format(alpha, mu)
tdc .color = "brown"
methods.append(tdc)
